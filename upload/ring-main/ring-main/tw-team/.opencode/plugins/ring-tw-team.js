/**
 * Ring TW Team plugin for OpenCode.ai
 *
 * Registers the ring-tw-team skills directory with OpenCode. The `using-ring`
...
export const RingTwTeamPlugin = async ({ client, directory }) => {
  const ringSkillsDir = path.resolve(__dirname, '../../skills');

  return {
    // Register the ring-tw-team skills path so OpenCode discovers them without
