/**
 * Ring PM Team plugin for OpenCode.ai
 *
 * Registers the ring-pm-team skills directory with OpenCode. The `using-ring`
...
export const RingPmTeamPlugin = async ({ client, directory }) => {
  const ringSkillsDir = path.resolve(__dirname, '../../skills');

  return {
    // Register the ring-pm-team skills path so OpenCode discovers them without
